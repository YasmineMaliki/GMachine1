...
<script src="script/machinesAchete.js" type="text/javascript"></script>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control"  type="date" placeholder="dd/mm/yyyy" id="date1" required>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input class="form-control" type="date" placeholder="dd/mm/yyyy" id="date2" required>
                            </div>
                          </div>
                        </div>
                      </div> 
                      <div class="add-items d-flex flex-wrap flex-sm-nowrap">
                    	  <button type="button" class="add btn btn-primary  font-weight-regular text-nowrap" id="rechercherM" > Rechercher Machine </button>
                   	</div>              
                    </form>
                  </div>
                </div>
